...
from libconfig.jinja2.utils import concat, internalcode, Markup
from libconfig.jinja2.environment import TemplateModule
from libconfig.jinja2.runtime import LoopContextBase, _last_iteration
...
def patch_template():
    from libconfig.jinja2 import Template
...
def patch_runtime():
    from libconfig.jinja2.runtime import BlockReference, Macro
...
def patch_filters():
    from libconfig.jinja2.filters import FILTERS
    from libconfig.jinja2.asyncfilters import ASYNC_FILTERS
